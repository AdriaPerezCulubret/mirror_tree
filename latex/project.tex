...
The MirrorTree is based on co-evolutionary methodology, as MirrorTree assumes that if a physical interaction exists between two proteins, they should co-evolve and moreover, they should share similar evolutionary history.
